 ...
 * 通用方法
 */
props.generic = function (method, biz_content) {
    var params = this.makeParams(method, biz_content);
    params.notify_url = this.notifyUrl;

    return utl.processParams(params, this.rsaPrivate, this.signType);
};

props.genericWithRequest = function (method, biz_content) {
    var body = props.generic(method, biz_content);
